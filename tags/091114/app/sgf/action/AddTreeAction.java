...
public class AddTreeAction extends AbstractAction{
    ...
    private static final String ADD_TREE = java.util.ResourceBundle.getBundle("app/resource/Resource").getString("AddTree");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        int retval = JOptionPane.showOptionDialog(goGame.getWindow(), panel, java.util.ResourceBundle.getBundle("app/resource/Resource").getString("AddTree"),
