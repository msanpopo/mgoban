...
public class PlusImage extends GoSimpleImage{
    
    public PlusImage(Color c) {
        super(c);
    }
    ...
    public void draw(Graphics2D g, int col, int row, Color color){
        ...
        g.translate(x, y);
        {
            ...
            g.setStroke(line);
            g.draw(new Line2D.Double(a - w, a, a + w, a));
            g.draw(new Line2D.Double(a, a - w, a, a + w));
        }
        g.setTransform(orig);
    }
}